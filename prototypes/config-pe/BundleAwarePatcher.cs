...
/// </summary>
public static class BundleAwarePatcher
{
    ...
    public static byte[] Personalize(byte[] source, string? icoPath, string scratchDir, out Report report)
    {
        ...
        try
        {
            ...
            if (icoPath is not null)
                IconPatcher.ApplyWin32(peTemp, icoPath);
